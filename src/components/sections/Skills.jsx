...
const Skills = () => {
 const skillCategories = {
  ...
  "CMS & Platforms": [
    ...
    skills.find((s) => s.name === "WooCommerce"),
  ].filter(Boolean),
  ...
  return (
    <section id="skills" className=" relative py-2 bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-0 w-96 h-96 bg-primary/10 rounded-full blur-3xl opacity-500" />
        <div className="absolute bottom-1/4 right-0 w-96 h-96 rounded-full blur-3xl opacity-500" />
      </div>
