        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-left">
                    ...
                    <FadeIn delay={100}>
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal text-white mb-6 leading-tight">Full Stack Web Developer Portfolio</h1>
                    </FadeIn>
                    <FadeIn delay={200}>
                        <p className="text-lg text-white/70 max-v-[550px] mb-8">I build modern, fast, and scalable websites using React, JavaScript, and WordPress. 
  Focused on creating responsive user experiences and high-performance web applications.</p>
                    </FadeIn>
                    <FadeIn delay={300}>
                        <button onClick={() => scrollToSection('contact')}
                            className="inline-flex items-center gap-o mb-12 group"
                            >
                ...
                <FadeIn delay={200}>
                    <div className="relative">
                        <div className="relative overflow-hidden rounded-2xl aspect-4/5 max-w-[500px] ml-auto group">
                            <div className="absoulte inset-0 rounded-2xl overflow-hidden">
                             ...
                             <div className="relative rounded-2xl overflow-hidden m-[1px] h-[calc(100%-2px)]">
                                <img className="w-full h-full object-cover" src="/images/developer-portrait.png" alt="Developer at work" />
                             </div>
